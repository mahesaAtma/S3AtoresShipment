<style>
    ...
    .packing-special .special-dimension > div {
        display: flex;
        align-items: center;
        margin: 0 auto;
    }

    .packing-special .special-container{
        display: flex;
        flex-direction: column;
    }

    .packing-special .special-container h6, .packing-special .special-section-2 h6{
        margin: 0 auto 10px 10px;
    }

    .packing-special .special-container input ,.packing-special .special-section-2 input{
        margin: 0 7px;
        padding: 10px 20px;
        border-radius: 10px;
    ...
    .packing-special .special-section-2 div{
        display: flex;
        flex-direction: column;
        width: 100%;
    }
    ...
    @media only screen and (max-width: 600px) {
        ...
        .packing-special .special-dimension > div h6 {
            margin-top: 10px;
        }
    }
</style>
