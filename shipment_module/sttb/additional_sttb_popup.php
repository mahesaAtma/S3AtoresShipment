...
<div class="sttb-popup-black-cover">
    <div class="sttb-popup-page regular-box-shadow-with-thin-border" style="max-height: 60vh; overflow-y:scroll;">
        ...
        <div class="sttb-popup-wrapper">
            <div class="sttb-popup-item-container">
                <?php include('./shipment_module/components/sttb/additional_sttb_entry.php') ?>
            </div>
        </div>
    </div>
</div>
