        ...
        <div class="container-fluid" style="min-height:80vh; max-height:80vh; overflow-y:scroll;">
           ...
           <?php
            ...
            <?php      
                    ...
                    echo "<a class='mt-2 mb-4' style='color:red;'>Driver belum memiliki order pickup</a>";
                }
            ?>
            <!-- Popup Section -->
            <?php
            ...
            <?php
                    ...
                    include('./shipment_module/components/qr_code_scanner.php');
                }
            ?>
        </div>
    </div>
